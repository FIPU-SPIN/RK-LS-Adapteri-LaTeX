...
This section outlines the experimental design, dataset, model architecture, training procedures, and evaluation metrics used to compare adapter-based fine-tuning with advanced prompting strategies for structured parsing tasks. This approach builds upon the framework established in our previous work \citep{karlovic2025large}, ensuring direct comparability while introducing new dimensions of analysis. The experiment is structured to rigorously test the formulated hypotheses by systematically evaluating performance, stability, robustness, and cost-effectiveness across both optimization paradigms. The following subsections detail each component of the methodology.

\subsection{Dataset}
\subsection{Model Architecture and Training Procedures}
